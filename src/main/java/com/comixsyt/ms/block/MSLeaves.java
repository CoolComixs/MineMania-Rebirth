...
public class MSLeaves extends BlockLeaves
{
    public static final String[][] Leaftypes = new String[][] {{"leaves_orange", "leaves_lemon", "leaves_cherry"}, {"leaves_orange_opaque", "leaves_lemon_opaque"}};
    public static final String[] Leaves = new String[] {"Orange", "Lemon", "Cherry"};
