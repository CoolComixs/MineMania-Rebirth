...
public class GuiLiquefier extends GuiContainer {
	...
	public GuiLiquefier(InventoryPlayer invPlayer, TileEntityLiquefier tile) {
		super(new ContainerLiquefier(invPlayer, tile));
		this.tileFurnace = tile;

	}

	private static final ResourceLocation furnaceGuiTextures = new ResourceLocation(
			"ms:textures/gui/liquefier_gui.png");
	private TileEntityLiquefier tileFurnace;
